...
{
    default void processTask(String s)
    {
        processTask(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void processTask(String s, java.util.Map<String, String> context)
    {
        _iceI_processTaskAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> processTaskAsync(String s)
    {
        return _iceI_processTaskAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> processTaskAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_processTaskAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_processTaskAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
