...
public interface Printer extends com.zeroc.Ice.Object
{
    ...
    void registerObserver(String observerId, NotificationPrx observerProxy, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_registerObserver(Printer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_observerId;
        NotificationPrx iceP_observerProxy;
        iceP_observerId = istr.readString();
        iceP_observerProxy = NotificationPrx.uncheckedCast(istr.readProxy());
        inS.endReadParams();
        obj.registerObserver(iceP_observerId, iceP_observerProxy, current);
        return inS.setResult(inS.writeEmptyParams());
    }
